  ...
  if (e.target.classList.contains("template-resume")) {
    quill.setContents([
      ...
      },
      {
        ...
        insert: "Insert text here Insert text here Insert text here ",
      },
      {
        insert: "\n",
      },
      ...
      },
      {
        ...
        insert:
          "Insert text here Insert text here Insert text here Insert text here Insert text here Insert text here Insert text here Insert text here.",
      },
      {
        insert: "\n",
      },
  ...
  if (e.target.classList.contains("template-recipe")) {
    quill.setContents([
      ...
      },
      {
        ...
        insert: '"Put the name of the recipe here"',
      },
      {
        insert: "\n\n",
      },
      ...
      },
      {
        ...
        insert: "Suspendisse scelerisque",
      },
      {
        attributes: {
          list: "bullet",
      ...
      },
      {
        ...
        insert:
          " consectetuer adipiscing elit sed do tempor incididunt ut labore et dolore magna aliqua. ",
      },
      {
        attributes: {
          list: "ordered",
      ...
      },
      {
        ...
        insert:
          " Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed dolore eiusmod tempor.",
      },
      {
        attributes: {
          list: "ordered",
      ...
      },
      {
        ...
        insert: "Vestibulum ante ipsum primis elementum",
      },
      {
        attributes: {
          background: "transparent",
        ...
        insert: ", libero interdum auctor cursus, sapien enim dictum quam.",
      },
      {
        attributes: {
          list: "ordered",
      ...
      },
      {
        ...
        insert: "Ullamco laboris nisi ut aliquip ex ea commodo consequat.",
      },
      {
        attributes: {
          list: "ordered",
